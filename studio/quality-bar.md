...
- [ ] LOD0 hero PBR maps may be albedo-only ≤256² (no `normalTexture`, no ORM texture) with constant roughness/metalness — `crate-toolbox` v0.33; loader does not rewrite materials
