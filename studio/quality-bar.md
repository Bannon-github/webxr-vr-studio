...
- [ ] Present-path directional / punctual off while XR presenting (hemisphere-only); restore lookdev `DirectionalLight` visible + intensity on session end (`crate-toolbox` v0.19)
