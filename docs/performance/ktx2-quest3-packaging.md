...
# 1. Cap prop maps. crate-toolbox LOD0 PBR may omit normalTexture
#    (albedo + ORM ≤256²). LOD1 and LOD2 should have no
#    baseColorTexture (or a 1×1). Do not use a global resize to
#    smash a larger authored hero if that object still ships 512;
#    crate-toolbox v0.32 authors LOD0 albedo+ORM at 256. Skip when
