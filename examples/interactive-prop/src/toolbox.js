 ...
 * change `frustumCulled`. Load-time only — not per-frame.
 *
 * Walks every non-interleaved `BufferAttribute` in
 * `geometry.attributes` plus `geometry.index` when it is a
 ...
 * Mesh / Object3D `boundingSphere` (v0.93). Does not delete
