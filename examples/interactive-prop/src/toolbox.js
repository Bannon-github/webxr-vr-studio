 ...
 * geometry, the attributes, or the typed arrays. It does **not**
 * touch Material `name` (left for a later pulse). It does **not**
 ...
 * Does not touch Material `name`. Does not touch prior material
