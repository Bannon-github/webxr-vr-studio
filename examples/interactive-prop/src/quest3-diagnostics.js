...
function paintBudgetOnce() {
  ...
  const tex = l2
    ? `${l2.textureSize}² LOD0 ${l2.maps} · LOD1 color-only ${l2.lodMaterialClass?.[1] ?? "MeshBasic"} / LOD2 color-only ${l2.lodMaterialClass?.[2] ?? "MeshBasic"} ×${l2.uniqueTextures} (authoring est.)`
    : "tex ≤1024²";
