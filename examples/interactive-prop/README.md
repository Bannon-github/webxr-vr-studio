...
| L3 LODs | LOD0 240 tris / 14 draws; LOD1 96 / 8; LOD2 24 / 2 (Three.js index counts). Auto switch 2.4 m / 4.5 m. LOD1 and LOD2 materials are albedo-only (omit `normalMap` and ORM). Colliders are not LOD meshes. |
